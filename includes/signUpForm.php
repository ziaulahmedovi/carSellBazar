    ...
    ?>
            ...
            <div class="row">
                ...
                <form action="" method="post" class="form col-12" enctype="multipart/form-data" name="form">
                     <h1 class="text_center">Create Account</h1>
                    ...
                    <label for="" class="col-1 "> </label>
                    <div class="col-8">
                        <input type="text" name="mobileNumber" value="01">
                    </div>
                    </div>
...
<!--                    <option value="admin">Admin</option>-->
                    ...
                    <div class="col-8">
                        <input type="submit" class="sunmit_btn" value="Sign Up" name="btn" onclick="return validation()">
                    </div>
                    </div>
                </form>
